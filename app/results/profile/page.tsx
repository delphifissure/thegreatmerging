    ...
    <div className="space-y-6">
      ...
      {!profile ? (
        <Waiting title="Your profile has not been generated yet." refresh={false}>
          It is created when interpretation finishes.{" "}
        ...
        <>
          ...
          <Card>
            ...
            {profile.tags.length === 0 ? (
              <p className="mt-2 text-sm text-muted">None yet. Tags are written in the color layer.</p>
            ) : (
          ...
          <Card>
            ...
            <p className="mt-1 text-sm text-muted">Instrument scores are labelled by source; everything derived is labelled generated by the interpreter; not validated.</p>
            <div className="mt-3">
      ...
      {!profile ? <Notice>Once interpretation has run, this page lists your validated scores with their sources and lets you share or export the profile.</Notice> : null}
    </div>
  );
}
