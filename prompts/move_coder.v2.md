...
- `contempt`: mocks, insults, calls the other a name, sneers, or talks down to them. A complaint about what someone did is `criticizes`; an attack on who they are is `contempt`.
