...
- Conversations end, and this one will end when one of you ends it. It is over when someone has left or refused to go on, when it has been settled or dropped, or when there is nothing more either of you would say right now. Do not keep it alive once it is over, and do not end it early to be tidy: most arguments stop unfinished, and some go round the same point several times first.
