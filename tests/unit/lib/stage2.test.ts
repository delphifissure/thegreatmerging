...
describe("privateResultsFor", () => {
  ...
  it("puts code-generated mental-health sentences first and drops the model's mental-health sentences", () => {
    ...
    expect(res.generated_label).toBe("The sentences above were written by the app from your answers, with the scores taken from the questionnaires. Not a validated result.");
  });
